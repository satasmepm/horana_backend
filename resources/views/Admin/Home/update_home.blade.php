    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="forms-sample" action="{{ route('home.update', $homes->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="tower_id" id="tower_id" class="form-control">
                                        ...
                                        @foreach ($towers as $tower)
                                            <option @if($tower->id==$homes->tower->id) selected @endif  value="{{ $tower->id }}">{{ $tower->tower_name }}</option>
                                        @endforeach
                                    </select>
                                    <span
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="floor_id" id="floor_id" class="form-control">
                                        ...
                                        @foreach ($floors as $floor)
                                            <option  @if($floor->id==$homes->floor->id) selected @endif value="{{ $floor->id }}">{{ $floor->floor_number }}</option>
                                        @endforeach
                                    </select>
                                    <span
