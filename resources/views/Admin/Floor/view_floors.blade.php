        ...
        <div class="modal-dialog " role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">View Floor</h5>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="floor_number" placeholder="Enter floor number here"
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            return '<button style="margin-right:5px" data-id=' + row.id +
                                ...
                                '<a href="floor/' + row.id + '/edit"><button  data-id=' + row
                                .id +
            ...
            $(document).on('click', '#view', function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('input[name="floor_number"]').val(response.data.floor_number);
                    },
                })
            });
            //data load in to modal selected employee
